			...
			<form method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<?php foreach ( $post_types as $post_type_val ) { ?>
							<input type="checkbox" id="wpsite_post_status_notifications_settings_post_types_<?php echo esc_attr( $post_type_val ); ?>" name="wpsite_post_status_notifications_settings_post_types_<?php echo esc_attr( $post_type_val ); ?>" <?php echo ( ! empty( $settings['post_types'] ) && in_array( $post_type_val, $settings['post_types'], true ) ? 'checked="checked"' : '' ); ?>/><span><?php echo esc_html( $post_type_val ); ?></span><br />
						<?php } ?>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="wpsite_post_status_notifications_settings_message_from_name" name="wpsite_post_status_notifications_settings_message_from_name" type="text" class="form-control" value="<?php echo ( isset( $settings['message']['from_name'] ) ? esc_attr( $settings['message']['from_name'] ) : esc_html( get_bloginfo( 'name' ) ) ); ?>" placeholder="<?php esc_html_e( 'My Website Name or My Company Name' ); ?>">
				...
				<div class="modal-dialog" role="document" style="margin-top: 10vh;width: 800px;max-width: 100%;">
					<div class="modal-content">
						...
						<div class="modal-body">
							<img style="width: 100%;" src="<?php echo esc_url( WPSITE_POST_STATUS_NOTIFICATION_PLUGIN_URL . '/img/post-published.png' ); ?>"/>
						</div>
			...
			<div class="modal fade" id="post-published-contributor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document" style="margin-top: 10vh;width: 800px;max-width: 100%;">
					<div class="modal-content">
						...
						<div class="modal-body">
							<img style="width: 100%;" src="<?php echo esc_url( WPSITE_POST_STATUS_NOTIFICATION_PLUGIN_URL . '/img/post-published-contributor.png' ); ?>"/>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal"><?php esc_html_e( 'Close', 'wpsite-post-status-notification' ); ?></button>
						</div>
			...
			<div class="modal fade" id="submit-for-review" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document" style="margin-top: 10vh;width: 800px;max-width: 100%;">
					<div class="modal-content">
						...
						<div class="modal-body">
							<img style="width: 100%;" src="<?php echo esc_url( WPSITE_POST_STATUS_NOTIFICATION_PLUGIN_URL . '/img/please-moderate.png' ); ?>"/>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal"><?php esc_html_e( 'Close', 'wpsite-post-status-notification' ); ?></button>
						</div>
